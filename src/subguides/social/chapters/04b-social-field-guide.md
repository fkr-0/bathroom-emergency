...
A brief absence usually needs no explanation. A longer absence may benefit from
one message to one person. Context matters more than a universal minute count: a
board meeting, a date, a house party, and a family gathering operate on entirely
different clocks.

The useful rule is simple: **when silence is likely to create concern or practical
problems, send one bounded message before your anxiety writes a six-part
miniseries about it.**
