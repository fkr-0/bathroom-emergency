...
print(f"Illustration validation passed: {len(current)} current non-Vega figures plus {len(migrated)} migrated audit records, including four-visual B and H vertical slices, at {VERSION}.")
